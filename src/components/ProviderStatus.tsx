      ...
      <div className="flex items-center justify-between pb-3 border-b border-border-subtle">
        <div className="flex items-center gap-3">
          ...
          <div className="flex flex-col">
            <h2 className="text-lg font-bold text-text-main leading-tight flex items-center gap-1">{desc.displayName}{p.usage?.accountEmail && <span className="text-[11px] font-normal text-text-muted/75 border border-border-subtle px-1 py-0.5 rounded align-middle ml-1">{p.usage.accountEmail}</span>}{p.source && <SourceBadge source={p.source} />}</h2>
