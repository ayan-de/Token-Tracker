        ...
        {p.unavailable ? (
          <div className="py-8 flex flex-col items-center justify-center text-center">
            ...
            <button
              ...
              className="mt-3 px-3 py-1 bg-accent-blue/15 text-accent-blue hover:bg-accent-blue/25 text-xs font-medium rounded-lg border border-accent-blue/20 transition-all"
            >
              Add Account...
            </button>
          </div>
