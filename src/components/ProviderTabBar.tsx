...
const ProviderTab = memo(function ProviderTab({
  ...
  return (
    <button
      ...
      className={`flex flex-col items-center gap-1.5 px-3 py-2 rounded-sm text-[10px] font-semibold whitespace-nowrap cursor-pointer border-0 outline-none focus:outline-none shrink-0 ${
        isSelected
