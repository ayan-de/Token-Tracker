...
//!
//! Provides toast notifications for usage alerts
...
'@
    ...
    fn show_toast(&self, title: &str, body: &str) {
        ...
        if let Err(e) = Notification::new()
            ...
            .show()
        {
            tracing::warn!("Failed to show notification via notify-rust: {}", e);
            ...
            tracing::debug!("Sent notification via notify-rust: {}", title);
        }
    }
}
...
/// Register the CodexBar App User Model ID (AUMID) in the Windows registry
#[cfg(target_os = "windows")]
